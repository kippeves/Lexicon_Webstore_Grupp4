    ...
    <FilterCard id="search" title="Search">
      <div className="flex focus-within:outline-2 border border-primary-green outline-primary-green rounded-sm">
        ...
        <Button
          ...
          type="button"
          className="rounded-s-none rounded-e-sm bg-white border border-y-0 border-e-0 border-s-primary-green hover:text-white text-primary-green hover:bg-primary-green"
        >
          <Search />
        </Button>
      </div>
